...
for n in np.arange(z_carrier[0:b_size].size):
  ...
  plt.savefig('/content/drive/MyDrive/4D_flower/primes_4D_flower%d.png' % n)

   

plt.savefig(f'/content/drive/MyDrive/4D_flower/0s0000_primess_observer_LAST_image.png',dpi=dots_per_inch)
plt.show()
